...
@router.get("/")
def get_all_coupons(page: int = 1, per_page: int = 10):
    """
    Obtiene todos los cupones desde WordPress/WooCommerce.
    Soporta paginación mediante query parameters.
    ...
    try:
        ...
        if response.status_code != 200:
            raise HTTPException(
                ...
                detail=f"Error al obtener los cupones en WooCommerce: {response.text}"
            )
